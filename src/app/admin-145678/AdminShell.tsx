...
import { AdminNav } from "@/app/admin-145678/AdminNav";
    ...
    <AdminChromeContext.Provider value={value}>
      ...
      >
        ...
        >
          <div
            className={cn(
              "flex shrink-0 items-center gap-2 border-b border-[var(--admin-border)] px-3",
              collapsed ? "h-auto flex-col py-3 lg:px-2" : "h-14",
            )}
          >
            <div className="flex w-full items-center gap-2">
              ...
              <button
                ...
                className={cn(
                  "hidden rounded-md p-1.5 text-[var(--admin-muted)] transition-colors hover:bg-[var(--admin-surface-muted)] hover:text-[var(--admin-fg)] lg:inline-flex",
                  collapsed && "lg:hidden",
                )}
            ...
            {collapsed && (
              <button
                type="button"
                onClick={toggleCollapsed}
                className="hidden rounded-md p-1.5 text-[var(--admin-muted)] transition-colors hover:bg-[var(--admin-surface-muted)] hover:text-[var(--admin-fg)] lg:inline-flex"
