...
import { StatCard } from "@/app/admin-145678/components/StatCard";
import {
  DataTable,
  DataTableBody,
  DataTableEmpty,
...
import { PageHeader } from "@/app/admin-145678/components/PageChrome";
import { StatusBadge, paymentTone } from "@/app/admin-145678/components/StatusBadge";
    ...
    <div className="animate-admin-fade space-y-8">
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between gap-3">
          ...
          <Link href="/admin-145678/bookings" className={adminUi.brandLink}>
            View all →
          </Link>
        </div>
            ...
            {recent.items.length === 0 ? (
              ...
              recent.items.map((row) => (
                <DataTableRow key={row.id}>
                  <Td>
                    <Link
                      href={`/admin-145678/bookings/${row.id}`}
